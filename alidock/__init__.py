...
class AliDock(object):
    ...
    def getSshCommand(self):
        ...
        except (docker.errors.NotFound, requests.exceptions.ChunkedEncodingError, KeyError) as exc:
    ...
    def shell(self, cmd=None):
        ...
        except (docker.errors.NotFound, requests.exceptions.ChunkedEncodingError, KeyError):
            xPort = None
